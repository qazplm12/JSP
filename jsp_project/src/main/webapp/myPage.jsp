...
<div class="container">
    <div class="col-5 mx-auto mt-5 pt-5">
        <form action="myPage.do" method="post" class="form-control">
            <h2 class="p-2"><a href="main.do">.log</a></h2>
            <h2 class="text-center my-4">내 정보</h2>
            <div class="form-floating my-4 ">
                <input type="text" class="form-control" id="user-id" name="userId" readonly value="${sessionScope.get('userId')}">
                <label for="user-id">아이디</label>
            </div>
            <div class="form-floating my-4">
                <input type="text" class="form-control" id="user-name" name="userName" value="${sessionScope.get('userName')}">
                <label for="user-name">이름</label>
            </div>
            <div class="form-floating my-4">
                <input type="email" class="form-control" id="user-email" name="userEmail" value="${sessionScope.get('userEmail')}">
            ...
            <div class="my-3 d-grid gap-3">
                <button type="submit" class="btn btn-primary" id="btn-submit" disabled>정보 수정</button>
            </div>
        </form>
    </div>
</div>
