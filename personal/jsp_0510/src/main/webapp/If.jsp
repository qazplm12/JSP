...
<%-- jstl을 사용하여 page영역에 저장된 변수 number를 가져와서 2로 나눈 나머지를 0과 같은지 확인--%>
...
<%-- jstl을 사용하여 apge 영역에 저장된 변수 string의 값과 문자열을 비교하고 page 영역의 result2변수에 저장--%>
<%-- 로그인 상태에 따라서 화면을 다르게 표현할 때 주로 사용--%>
    <c:if test="${string eq 'Java'}" var="result2">
        문자열은 Java입니다. <br>
    </c:if>
<%-- jstl을 사용하여 page영역에 저장된 result2 변수가 값에 not 연산자를 사용하여 if ~ else 문을 구현--%>
<%-- <c:if test="${!result2}">--%>
